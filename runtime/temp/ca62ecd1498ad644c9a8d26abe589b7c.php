...
<html><head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1.0, maximum-scale=1.0"><meta name="keywords" content=""><meta name="description" content=""><link rel="stylesheet" href="/public/css/style.css"><!--<link rel="stylesheet" href="/public/js/layer_mobile/need/layer.css">--><!--JQ--><!--<script src="/static/plugs/jquery/jquery.min.js"></script>--><!--<script type="text/javascript" src="/statics/js/swiper.3.1.7.min.js"></script>--><!--<script type="text/javascript" src="/statics/js/jquery.SuperSlide.2.1.1.js"></script>--><!--<script type="text/javascript" src="/statics/js/TouchSlide.1.0.js"></script>--><!--<script type="text/javascript" src="/statics/js/jquery.simplesidebar.js"></script>--><script>    (function () {
    ...
    </style></head><body style="background-color:#ffffff; padding-bottom: 4rem;"><header><div class="back" onclick="window.history.back(-1)"></div><span>会员升级</span></header><div style="height: 40px"></div><!-- 头部部分 开始 --><div class="vip_car"><div class="vip_car_xx"><img  class="vip_car_logo" src="<?php echo htmlentities($info['headpic']); ?>" alt="" onerror="this.src='/public/img/head.png'"><p class="vip_car_logo_name" style="width: auto;">会员等级：<?php echo htmlentities($level_name); ?></p><p class="vip_car_logo_rw">每天可接单：<span id="num_task"><?php echo htmlentities($order_num); ?></span> (单)</p><a class="vip_car_hyxq" href="/index/my/index">会员详情</a><!--<div class="vip_car_hyjj"><p class="vip_car_hytq"><span>下级任务佣金</span><span style="float: right;">下级会员佣金</span></p><p class="vip_car_yjsl"><span>10%</span><span style="float: right;">20%</span></p></div>--></div></div><div class="vip_xxjss"><ul><li><img src="/public/img/v1.png"><p>佣金加成</p></li><li><img src="/public/img/v2.png"><p style="color: #e65a69;">任务增多</p></li><li><img src="/public/img/v3.png"><p style="color: #33cdf8;">专属客服</p></li></ul></div><p style="text-align: center;color: #d4d2d2;">左右滑动查看更多</p><!--</div>--><div class="swiper-container vio_rwktlb" id="vip_sel" style="width: 100%;margin-left:0"><div class="swiper-wrapper"><?php
        //var_dump($info,$member_level);die;

        foreach($member_level as $key=>$vo): $lv = $vo['id'] == $info['level'] ? 1 : ''  ?><li class="swiper-slide sub <?php echo $vo['level'] > $info['level'] ? 'lv' :'' ;?>  " data-id="<?php echo htmlentities($vo['level']); ?>" data-price="<?php echo htmlentities($vo['num']); ?>" ><p class="vip_hylss"><?php echo htmlentities($vo['name']); ?></p><p class="vip_hyjg"><?php echo htmlentities($vo['num']); ?><span>元</span></p><p  class="vip_yuanjia2">提现次数:<?php echo htmlentities($vo['tixian_ci']); ?>/天</p><p  class="vip_yuanjia2">提现额度:<?php echo htmlentities($vo['tixian_max']); ?></p><p  class="vip_yuanjia2">接单数量:<?php echo htmlentities($vo['order_num']); ?>/天</p><p  class="vip_yuanjia2">佣金比例:<?php echo htmlentities($vo['bili']); ?></p><p data-name="<?php echo !empty($lv) ? htmlentities($lv) :  ''; ?>" class="vip_yuanjia <?php echo $lv? 'isc': '' ?> ">会员永久有效</p></li><?php endforeach; ?></div><!-- Add Pagination --><div class="swiper-pagination"></div></div><input type="hidden"  id="is_vip_price" value="1"><input type="hidden"  id="is_vip_bu" value="1"><input type="hidden" name="price" id="price" value=""><input type="hidden" name="level" id="level" value=""><div class="recharge_box" style="margin-top: 0;border-top: 0; padding-bottom: 40px;display: none"><input type="hidden" name="payment_type" id="payment_type" value=""><label data-key="999"><img src="/public/img/yq.png" class="avatar" alt=""><a>余额支付</a><span class=""></span></label><?php foreach($list as $key=>$vo): ?><label data-key="<?php echo htmlentities($vo['id']); ?>"><img src="<?php echo htmlentities($vo['ico']); ?>" class="avatar" alt=""><a><?php echo htmlentities($vo['name']); ?></a><span class=""></span></label><?php endforeach; ?></div><button data-name="1" style="display: none;margin-top:60px" id="submit" class="vip_lijisj">立即升级<span id="show_price_1"></span></button><!-- </form> --><div class="recharge_box2 task_box" style="text-align:center;display:none ;z-index:99999" ><div class="con" style="background: #fff;padding:15px"><ul style="display: block;"><li><a onclick="javascript:void(0)" class="link"><p class="clear"><span class="t">支付方式</span><span class="zhuangtai2"><img id="ico" src="" alt="" style="width: 30px;height: 30px;"></span></p></a><a onclick="javascript:void(0)" class="link" style="margin-top: 10px"><p class="clear"><span class="t">订单号</span><span class="zhuangtai" id="orderId">12345678945</span></p></a><a onclick="javascript:void(0)" class="link"><p class="clear"><span class="t">充值金额</span><span class="zhuangtai2" id="price2">50</span></p></a></li></ul><div id="erweima_div" style="display: block;text-align: center;height: 200px;"><img src="" id="erweima" alt="" height="150"></div></div><label style="padding:0">*如需帮助，可联系客服人工充值</label><button type="button" class="cancel vip_lijisj">取消</button><button type="submit" id="submit_cz" class="vip_lijisj">确认充值</button><div id="pay_desc" style="text-align: left"></div></div><script>    $(document).ready(function(){
