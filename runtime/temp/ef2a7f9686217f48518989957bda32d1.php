<?php /*a:1:{s:64:"/www/wwwroot/ee.00008i.com/application/index/view/ctrl/sgsc.html";i:1691101599;}*/ ?>

<!DOCTYPE html><!-- saved from url=(0043)https://shop2.client.yiovo.com/index.html#/ --><html lang="zh-CN"
      style="--status-bar-height: 0px; --top-window-height: 0px; --window-left: 0px; --window-right: 0px; --window-margin: 0px; --window-top: calc(var(--top-window-height) + calc(44px + env(safe-area-inset-top))); --window-bottom: calc(50px + env(safe-area-inset-bottom));"
      version="4"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>手工商城</title><script>var coverSupport = 'CSS' in window && typeof CSS.supports === 'function' && (CSS.supports('top: env(a)') || CSS.supports('top: constant(a)'))
    document.write('<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0' + (coverSupport ? ', viewport-fit=cover' : '') + '" />')</script><meta name="viewport"
          content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, viewport-fit=cover"><link rel="stylesheet" href="/static/yhc_files/index.a5c69d49.css"><style type="text/css">
        @charset "UTF-8";
 ...
 */
        ...
        @font-face {
            ...
            /* Project id 2282770 */
            src: url(https://at.alicdn.com/t/font_2282770_p9nx0bv86i.woff2?t=1649761463203) format("woff2"), url(https://at.alicdn.com/t/font_2282770_p9nx0bv86i.woff?t=1649761463203) format("woff"), url(https://at.alicdn.com/t/font_2282770_p9nx0bv86i.ttf?t=1649761463203) format("truetype"), url(https://at.alicdn.com/t/font_2282770_p9nx0bv86i.svg?t=1649761463203#iconfont) format("svg")
        }
        ...
        uni-page {
            box-shadow: 0 1px 22px hsla(0, 0%, 66.3%, .3)
        }
        ...
        body {
            ...
            src="/static/yhc_files/pages-address-create~pages-address-update~pages-cart-index~pages-checkout-index~pages-comment-index~~1f503729.bdbf636b.js"></script><script charset="utf-8"
            src="/static/yhc_files/pages-article-detail~pages-custom-index~pages-goods-detail~pages-index-index.ad5c9a39.js"></script><script charset="utf-8" src="/static/yhc_files/pages-custom-index~pages-index-index.4d9e4c19.js"></script><script charset="utf-8" src="/static/yhc_files/pages-index-index.812690b4.js"></script><style type="text/css">
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-search[data-v-fffb5964] {
            background: #f1f1f2;
            padding: 10px 10px;
            font-size: 13px
        }

        .inner[data-v-fffb5964] {
            height: 31px;
            background: #fff;
            overflow: hidden
        }

        .inner.radius[data-v-fffb5964] {
            border-radius: 5px
        }

        .inner.round[data-v-fffb5964] {
            border-radius: 31px
        }

        .search-input[data-v-fffb5964] {
            height: 31px;
            line-height: 31px;
            color: #999;
            padding: 0 10px
        ...
        .search-input .search-icon[data-v-fffb5964] {
            margin-right: 4px
        }
    </style><style type="text/css">
        @charset "UTF-8";
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-imageSingle .item-image .image[data-v-1eb36b0c] {
            display: block;
            width: 100%
        }
    </style><style type="text/css">
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-banner[data-v-a7d5e724] {
            position: relative
            /* 指示点 */
        }

        .diy-banner .swiper-box[data-v-a7d5e724] {
            height: 100%
        }

        .diy-banner .swiper-box .slide-image[data-v-a7d5e724] {
            width: 100%;
            height: 100%;
            margin: 0 auto;
            display: block
        ...
        .diy-banner .indicator-dots[data-v-a7d5e724] {
            width: 100%;
            height: 14px;
            padding: 0 10px;
            position: absolute;
        ...
        .diy-banner .indicator-dots .dots-item[data-v-a7d5e724] {
            width: 8px;
            height: 8px;
            margin-right: 4px;
            background-color: #fff
        ...
        .diy-banner .indicator-dots .dots-item[data-v-a7d5e724]:last-child {
            margin-right: 0
        }

        .diy-banner .indicator-dots .dots-item.active[data-v-a7d5e724] {
            background-color: #313131 !important
        }

        .diy-banner .indicator-dots.round .dots-item[data-v-a7d5e724] {
            width: 8px;
            height: 8px;
            border-radius: 10px
        }

        .diy-banner .indicator-dots.square .dots-item[data-v-a7d5e724] {
            width: 8px;
            height: 8px
        }

        .diy-banner .indicator-dots.rectangle .dots-item[data-v-a7d5e724] {
            width: 11px;
            height: 7px
        }
    </style><style type="text/css">
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-window .data-list[data-v-c3261462]::after {
            clear: both;
            content: " ";
            display: table
        }

        .diy-window .data-list .data-item[data-v-c3261462] {
            float: left;
            box-sizing: border-box
        }

        .diy-window .data-list .image[data-v-c3261462] {
            display: block;
            width: 100%
        }

        /* 分列布局 */
        .diy-window .avg-sm-2 > .data-item[data-v-c3261462] {
            width: 50%
        }

        .diy-window .avg-sm-3 > .data-item[data-v-c3261462] {
            width: 33.33333333%
        }

        .diy-window .avg-sm-4 > .data-item[data-v-c3261462] {
            width: 25%
        }

        .diy-window .avg-sm-5 > .data-item[data-v-c3261462] {
            width: 20%
        }

        /* 橱窗样式 */
        .diy-window[data-v-c3261462] {
            box-sizing: border-box
        }

        .diy-window .display[data-v-c3261462] {
            height: 0;
            width: 100%;
            margin: 0;
            padding-bottom: 50%;
        ...
        .diy-window .display .image[data-v-c3261462] {
            width: 100%;
            height: 100%
        }

        .diy-window .display .display-left[data-v-c3261462] {
            width: 50%;
            height: 100%;
            position: absolute;
            top: 0;
        ...
        .diy-window .display .display-right[data-v-c3261462] {
            width: 50%;
            height: 100%;
            position: absolute;
            top: 0;
        ...
        .diy-window .display .display-right1[data-v-c3261462] {
            width: 100%;
            height: 50%;
            position: absolute;
            top: 0;
        ...
        .diy-window .display .display-right2[data-v-c3261462] {
            width: 100%;
            height: 50%;
            position: absolute;
            top: 50%;
        ...
        .diy-window .display .display-right2 .left[data-v-c3261462] {
            width: 50%;
            height: 100%;
            position: absolute;
            top: 0;
        ...
        .diy-window .display .display-right2 .right[data-v-c3261462] {
            width: 50%;
            height: 100%;
            position: absolute;
            top: 0;
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-video .video[data-v-a0f6c1b8] {
            width: 100%;
            display: block
        }
    </style><style type="text/css">
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-article[data-v-d9182fbe] {
            background: #f7f7f7
        }

        .diy-article .article-item[data-v-d9182fbe] {
            margin-bottom: 10px;
            padding: 15px;
            background: #fff
        }

        .diy-article .article-item[data-v-d9182fbe]:last-child {
            margin-bottom: 0
        }

        .diy-article .article-item .article-item__title[data-v-d9182fbe] {
            max-height: 38px;
            font-size: 14px;
            line-height: 19px;
            color: #333
        ...
        .diy-article .article-item .article-item__image .image[data-v-d9182fbe] {
            display: block
        }

        /* 小图模式 */
        .show-type__10[data-v-d9182fbe] {
            display: flex
        }

        .show-type__10 .article-item__left[data-v-d9182fbe] {
            padding-right: 10px
        }

        .show-type__10 .article-item__image .image[data-v-d9182fbe] {
            width: 124px
        }

        /* 大图模式 */
        .show-type__20 .article-item__image .image[data-v-d9182fbe] {
            width: 100%
        }
    </style><style type="text/css">
        @charset "UTF-8";
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .u-notice-bar-wrap[data-v-386306c2] {
            overflow: hidden
        }
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-navBar .data-list[data-v-75bc6be2]::after {
            clear: both;
            content: " ";
            display: table
        }

        .item-nav[data-v-75bc6be2] {
            float: left;
            margin: 10px 0;
            text-align: center
        }

        .item-nav .item-text[data-v-75bc6be2] {
            font-size: 13px
        }

        .item-nav .item-image[data-v-75bc6be2] {
            margin-bottom: 4px;
            font-size: 0
        }

        .item-nav .item-image .image[data-v-75bc6be2] {
            width: 45px;
            height: 45px
        }

        /* 分列布局 */
        .diy-navBar .avg-sm-3 > .item-nav[data-v-75bc6be2] {
            width: 33.33333333%
        }

        .diy-navBar .avg-sm-4 > .item-nav[data-v-75bc6be2] {
            width: 25%
        }

        .diy-navBar .avg-sm-5 > .item-nav[data-v-75bc6be2] {
            width: 20%
        }
    </style><style type="text/css">
        @charset "UTF-8";
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-goods .goods-list[data-v-22fcf626] {
            padding: 2px;
            box-sizing: border-box
        }

        .diy-goods .goods-list .goods-item[data-v-22fcf626] {
            box-sizing: border-box;
            padding: 3px
        }

        .diy-goods .goods-list .goods-item .goods-image[data-v-22fcf626] {
            position: relative;
            width: 100%;
            height: 0;
            padding-bottom: 100%;
        ...
        .diy-goods .goods-list .goods-item .goods-image[data-v-22fcf626]:after {
            content: "";
            display: block;
            margin-top: 100%
        }

        .diy-goods .goods-list .goods-item .goods-image .image[data-v-22fcf626] {
            position: absolute;
            width: 100%;
            height: 100%;
            top: 0;
        ...
        .diy-goods .goods-list .goods-item .detail[data-v-22fcf626] {
            padding: 4px;
            background: #fff
        }

        .diy-goods .goods-list .goods-item .detail .goods-name[data-v-22fcf626] {
            min-height: 35px;
            line-height: 1.3;
            white-space: normal;
            color: #484848;
        ...
        .diy-goods .goods-list .goods-item .detail .detail-price .goods-price[data-v-22fcf626] {
            margin-right: 4px
        }

        .diy-goods .goods-list .goods-item .detail .detail-price .line-price[data-v-22fcf626] {
            text-decoration: line-through
        }

        .diy-goods .goods-list.display__slide[data-v-22fcf626] {
            white-space: nowrap;
            font-size: 0
        }

        .diy-goods .goods-list.display__slide .goods-item[data-v-22fcf626] {
            display: inline-block
        }

        .diy-goods .goods-list.display__list .goods-item[data-v-22fcf626] {
            float: left
        }

        .diy-goods .goods-list.column__2 .goods-item[data-v-22fcf626] {
            width: 50%
        }

        .diy-goods .goods-list.column__3 .goods-item[data-v-22fcf626] {
            width: 33.33333%
        }

        .diy-goods .goods-list.column__1 .goods-item[data-v-22fcf626] {
            width: 100%;
            height: 145px;
            margin-bottom: 6px;
            padding: 10px;
        ...
        .diy-goods .goods-list.column__1 .goods-item[data-v-22fcf626]:last-child {
            margin-bottom: 0
        }

        .diy-goods .goods-list.column__1 .goods-item_left[data-v-22fcf626] {
            display: flex;
            width: 40%;
            background: #fff;
            align-items: center
        ...
        .diy-goods .goods-list.column__1 .goods-item_left .image[data-v-22fcf626] {
            display: block;
            width: 124px;
            height: 124px
        }

        .diy-goods .goods-list.column__1 .goods-item_right[data-v-22fcf626] {
            position: relative;
            width: 60%
        }

        .diy-goods .goods-list.column__1 .goods-item_right .goods-name[data-v-22fcf626] {
            margin-top: 10px;
            min-height: 35px;
            line-height: 1.3;
            white-space: normal;
        ...
        .diy-goods .goods-list.column__1 .goods-item_desc[data-v-22fcf626] {
            margin-top: 4px
        }

        .diy-goods .goods-list.column__1 .desc-selling_point[data-v-22fcf626] {
            width: 208px;
            font-size: 12px;
            color: #e49a3d
        }

        .diy-goods .goods-list.column__1 .desc-goods_sales[data-v-22fcf626] {
            color: #999;
            font-size: 12px
        }

        .diy-goods .goods-list.column__1 .desc_footer[data-v-22fcf626] {
            font-size: 12px
        }

        .diy-goods .goods-list.column__1 .desc_footer .price_x[data-v-22fcf626] {
            margin-right: 8px;
            color: #f03c3c;
            font-size: 15px
        }

        .diy-goods .goods-list.column__1 .desc_footer .price_y[data-v-22fcf626] {
            text-decoration: line-through
        }
    </style><style type="text/css">
        @charset "UTF-8";
 ...
 */
        ...
        .diy-service .service-icon[data-v-e52309a8] {
            padding: 5px
        }

        .diy-service .service-icon .image[data-v-e52309a8] {
            display: block;
            width: 46px;
            height: 46px;
            border-radius: 50%;
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .diy-guide .line[data-v-69980692] {
            width: 100%
        }
    </style><style type="text/css">
        /* a 标签默认效果 */
        ...
        /* a 标签点击态效果 */
        ._hover[data-v-18858ca4] {
            text-decoration: underline;
            opacity: .7
        }

        /* 图片默认效果 */
        ._img[data-v-18858ca4] {
            display: block;
            max-width: 100%;
        ...
        ._q[data-v-18858ca4]::before {
            content: '"'
        }

        ._q[data-v-18858ca4]::after {
            content: '"'
        }
        ...
        ._sup[data-v-18858ca4] {
            font-size: smaller;
            vertical-align: super
        }

        ._thead[data-v-18858ca4],
        ._tbody[data-v-18858ca4],
        ._tfoot[data-v-18858ca4] {
        ...
        ._ul ._ul[data-v-18858ca4] {
            margin: 0;
            list-style-type: circle
        }

        ._ul ._ul ._ul[data-v-18858ca4] {
            list-style-type: square
        }

        ._abbr[data-v-18858ca4],
        ._b[data-v-18858ca4],
        ._code[data-v-18858ca4],
        ._del[data-v-18858ca4],
        ._em[data-v-18858ca4],
 ...
 */
        ...
        /* 文章场景相关 */
        /* 引入uView全局scss变量文件 */
        .container[data-v-83c04282] {
            background: #fff
        }
    </style></head><body class="uni-body pages-index-index"><noscript><strong>Please enable JavaScript to
    continue.</strong></noscript><uni-app class="uni-app--showtabbar"><uni-page
            data-page="pages/index/index"><uni-page-head uni-page-head-type="default"><div class="uni-page-head"
                 style="background-color: rgb(255, 255, 255); color: black; transition-duration: 0ms; transition-timing-function: linear;"><div class="uni-page-head-hd"><div class="uni-page-head-btn" style="display: none;"><i class="uni-btn-icon"
                                                                             style="color: black; font-size: 27px;"></i></div><div class="uni-page-head-ft"></div></div><div class="uni-page-head-bd" style="left: 18px"><div class="uni-page-head__title" style="font-size: 17px; opacity: 1;text-align: left"><a href="/">返回首页</a></div></div><!----><div class="uni-page-head-bd" style="left: 100px"><div class="uni-page-head__title" style="font-size: 17px; opacity: 1;text-align: left"><a href="/support">联系客服</a></div></div><!----><div class="uni-page-head-ft"></div></div><div class="uni-placeholder"></div></uni-page-head><uni-page-refresh><div class="uni-page-refresh" style="margin-top: 44px;"><div class="uni-page-refresh-inner"><svg fill="#2BD009" width="24" height="24" viewBox="0 0 24 24"
                         class="uni-page-refresh__icon"><path
                                d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"></path><path d="M0 0h24v24H0z" fill="none"></path></svg><svg width="24" height="24" viewBox="25 25 50 50" class="uni-page-refresh__spinner"><circle stroke="#2BD009" cx="50" cy="50" r="20" fill="none" stroke-width="4" stroke-miterlimit="10"
                                class="uni-page-refresh__path"></circle></svg></div></div></uni-page-refresh><uni-page-wrapper><uni-page-body><uni-view data-v-83c04282="" class="container"><uni-view
                            data-v-4afd20ca="" data-v-83c04282="" class="page-items"><!--                        <uni-view data-v-fffb5964="" data-v-4afd20ca=""--><!--                                  class="diy-search">--><!--                            <uni-view data-v-fffb5964="" class="inner round">--><!--                                <uni-view data-v-fffb5964=""--><!--                                          class="search-input" style="text-align: left;">--><!--                                    <uni-text data-v-fffb5964=""--><!--                                              class="search-icon iconfont icon-search"><span></span></uni-text>--><!--                                    <uni-text--><!--                                            data-v-fffb5964=""><span>请输入关键字进行搜索</span></uni-text>--><!--                                </uni-view>--><!--                            </uni-view>--><!--                        </uni-view>&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;--><uni-view
                                data-v-a7d5e724="" data-v-4afd20ca="" class="diy-banner" style="height: 166.4px;"><uni-swiper
                                    data-v-a7d5e724="" class="swiper-box"><div class="uni-swiper-wrapper"><div class="uni-swiper-slides"><div class="uni-swiper-slide-frame"
                                             style="width: 100%; height: 100%; transform: translate(0%, 0px) translateZ(0px);"><uni-swiper-item data-v-a7d5e724=""
                                                             style="position: absolute; width: 100%; height: 100%; transform: translate(0%, 0px) translateZ(0px);"><uni-image
                                                        data-v-a7d5e724="" class="slide-image" style="height: 166px;"><div
                                                            style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/295000dccb12fe8d7fad7bc4814ec6f4.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;"></div><img src="/static/yhc_files/295000dccb12fe8d7fad7bc4814ec6f4.png"
                                                         draggable="false"><uni-resize-sensor><div><div></div></div><div><div></div></div></uni-resize-sensor></uni-image></uni-swiper-item><uni-swiper-item data-v-a7d5e724=""
                                                             style="position: absolute; width: 100%; height: 100%; transform: translate(100%, 0px) translateZ(0px);"><uni-image
                                                        data-v-a7d5e724="" class="slide-image" style="height: 166px;"><div
                                                            style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/1938bdd93e11675179b20410dabef3cc.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;"></div><img src="/static/yhc_files/1938bdd93e11675179b20410dabef3cc.png"
                                                         draggable="false"><uni-resize-sensor><div><div></div></div><div><div></div></div></uni-resize-sensor></uni-image></uni-swiper-item></div></div></div></uni-swiper><uni-view data-v-a7d5e724="" class="indicator-dots round"><uni-view data-v-a7d5e724=""
                                          class="dots-item active" style="background-color: rgb(213, 169, 136);"></uni-view><uni-view
                                        data-v-a7d5e724="" class="dots-item"
                                        style="background-color: rgb(213, 169, 136);"></uni-view></uni-view></uni-view><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><uni-view
                                data-v-65db301a="" data-v-4afd20ca="" class="diy-notice"
                                style="padding-top: 1px; padding-bottom: 1px;"><uni-view data-v-386306c2="" data-v-65db301a=""
                                      class="u-notice-bar-wrap" style="border-radius: 0px;"><uni-view data-v-4bc00da4="" data-v-386306c2=""
                                          class="u-notice-bar u-type-warning-light-bg" mode="horizontal"
                                          style="background: rgb(255, 251, 232); padding: 5px 12px;"><uni-view data-v-4bc00da4=""
                                              class="u-direction-row"><uni-view data-v-4bc00da4="" class="u-icon-wrap"><uni-view
                                                    data-v-0f4c3eed="" data-v-4bc00da4="" class="u-icon u-left-icon u-icon--right"><uni-text
                                                        data-v-0f4c3eed="" hover-class="" class="u-icon__icon uicon-volume-fill u-iconfont"
                                                        style="font-size: 17px; font-weight: normal; top: 0px; color: rgb(222, 140, 23);"><span></span></uni-text><!----></uni-view></uni-view><uni-view
                                                data-v-4bc00da4="" id="u-notice-box" class="u-notice-box"><uni-view data-v-4bc00da4=""
                                                      id="u-notice-content" class="u-notice-content"
                                                      style="animation-duration: 13.6345s; animation-play-state: running;"><uni-text
                                                        data-v-4bc00da4="" class="u-notice-text u-type-warning"
                                                        style="color: rgb(222, 140, 23); font-size: 14px;"><span>手工商城致力于通过产品和服务，帮助商家高效化开拓市场。</span></uni-text></uni-view></uni-view><uni-view
                                                data-v-4bc00da4=""
                                                class="u-icon-wrap"></uni-view></uni-view></uni-view><!----></uni-view></uni-view><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!--                        <uni-view--><!--                                data-v-75bc6be2="" data-v-4afd20ca="" class="diy-navBar"--><!--                                style="background: rgb(255, 255, 255); color: rgb(102, 102, 102);">--><!--                            <uni-view data-v-75bc6be2=""--><!--                                      class="data-list avg-sm-4">--><!--                                <uni-view data-v-75bc6be2="" class="item-nav">--><!--                                    <uni-view data-v-75bc6be2=""--><!--                                              class="nav-to">--><!--                                        <uni-view data-v-75bc6be2="" class="item-image">--><!--                                            <uni-image data-v-75bc6be2=""--><!--                                                       class="image" style="height: 46px;">--><!--                                                <div--><!--                                                        style="background-image: url(&quot;http://static.yoshop.xany6.com/10001/20210315/8749305b19496b7b5b0b098837357a80.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                                </div>--><!--                                                <img src="/static/yhc_files/8749305b19496b7b5b0b098837357a80.png"--><!--                                                     draggable="false">--><!--                                                <uni-resize-sensor>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                </uni-resize-sensor>--><!--                                            </uni-image>--><!--                                        </uni-view>--><!--                                        <uni-view data-v-75bc6be2=""--><!--                                                  class="item-text oneline-hide">居家生活--><!--                                        </uni-view>--><!--                                    </uni-view>--><!--                                </uni-view>--><!--                                <uni-view data-v-75bc6be2=""--><!--                                          class="item-nav">--><!--                                    <uni-view data-v-75bc6be2="" class="nav-to">--><!--                                        <uni-view data-v-75bc6be2=""--><!--                                                  class="item-image">--><!--                                            <uni-image data-v-75bc6be2="" class="image" style="height: 46px;">--><!--                                                <div--><!--                                                        style="background-image: url(&quot;http://static.yoshop.xany6.com/10001/20210315/003ebfff145bd74289b8ad5510b6a01e.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                                </div>--><!--                                                <img src="/static/yhc_files/003ebfff145bd74289b8ad5510b6a01e.png"--><!--                                                     draggable="false">--><!--                                                <uni-resize-sensor>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                </uni-resize-sensor>--><!--                                            </uni-image>--><!--                                        </uni-view>--><!--                                        <uni-view data-v-75bc6be2=""--><!--                                                  class="item-text oneline-hide">手机数码--><!--                                        </uni-view>--><!--                                    </uni-view>--><!--                                </uni-view>--><!--                                <uni-view data-v-75bc6be2=""--><!--                                          class="item-nav">--><!--                                    <uni-view data-v-75bc6be2="" class="nav-to">--><!--                                        <uni-view data-v-75bc6be2=""--><!--                                                  class="item-image">--><!--                                            <uni-image data-v-75bc6be2="" class="image" style="height: 46px;">--><!--                                                <div--><!--                                                        style="background-image: url(&quot;http://static.yoshop.xany6.com/10001/20210315/49251b6557e20faee7c67d9ee331a98b.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                                </div>--><!--                                                <img src="/static/yhc_files/49251b6557e20faee7c67d9ee331a98b.png"--><!--                                                     draggable="false">--><!--                                                <uni-resize-sensor>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                </uni-resize-sensor>--><!--                                            </uni-image>--><!--                                        </uni-view>--><!--                                        <uni-view data-v-75bc6be2=""--><!--                                                  class="item-text oneline-hide">领券中心--><!--                                        </uni-view>--><!--                                    </uni-view>--><!--                                </uni-view>--><!--                                <uni-view data-v-75bc6be2=""--><!--                                          class="item-nav">--><!--                                    <uni-view data-v-75bc6be2="" class="nav-to">--><!--                                        <uni-view data-v-75bc6be2=""--><!--                                                  class="item-image">--><!--                                            <uni-image data-v-75bc6be2="" class="image" style="height: 46px;">--><!--                                                <div--><!--                                                        style="background-image: url(&quot;http://static.yoshop.xany6.com/10001/20210315/7a5fde286eb3c79e80be0b3f82f2079b.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                                </div>--><!--                                                <img src="/static/yhc_files/7a5fde286eb3c79e80be0b3f82f2079b.png"--><!--                                                     draggable="false">--><!--                                                <uni-resize-sensor>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                    <div>--><!--                                                        <div></div>--><!--                                                    </div>--><!--                                                </uni-resize-sensor>--><!--                                            </uni-image>--><!--                                        </uni-view>--><!--                                        <uni-view data-v-75bc6be2=""--><!--                                                  class="item-text oneline-hide">运动户外--><!--                                        </uni-view>--><!--                                    </uni-view>--><!--                                </uni-view>--><!--                            </uni-view>--><!--                        </uni-view>&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;--><uni-view
                                data-v-1eb36b0c="" data-v-4afd20ca="" class="diy-imageSingle"
                                style="padding-bottom: 0px; background: rgb(255, 255, 255);"><uni-view data-v-1eb36b0c=""
                                      class="item-image" style="padding: 0px;"><uni-view data-v-1eb36b0c="" class="nav-to"><uni-image
                                            data-v-1eb36b0c="" class="image" style="height: 38px;"><div
                                                style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/0e7f6417ccccc90cf48f1359ea85ecc9.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;"></div><img src="/static/yhc_files/0e7f6417ccccc90cf48f1359ea85ecc9.png"
                                             draggable="false"><uni-resize-sensor><div><div></div></div><div><div></div></div></uni-resize-sensor></uni-image></uni-view></uni-view><!--                            <uni-view data-v-1eb36b0c="" class="item-image"--><!--                                      style="padding: 0px;">--><!--                                <uni-view data-v-1eb36b0c="" class="nav-to">--><!--                                    <uni-image data-v-1eb36b0c=""--><!--                                               class="image" style="height: 100px;">--><!--                                        <div--><!--                                                style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/a33f3214d24b6268d0262dcb16a93fd2.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                        </div>--><!--                                        <img src="/static/yhc_files/a33f3214d24b6268d0262dcb16a93fd2.png"--><!--                                             draggable="false">--><!--                                        <uni-resize-sensor>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                        </uni-resize-sensor>--><!--                                    </uni-image>--><!--                                </uni-view>--><!--                            </uni-view>--><!--                            <uni-view data-v-1eb36b0c="" class="item-image"--><!--                                      style="padding: 0px;">--><!--                                <uni-view data-v-1eb36b0c="" class="nav-to">--><!--                                    <uni-image data-v-1eb36b0c=""--><!--                                               class="image" style="height: 108px;">--><!--                                        <div--><!--                                                style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/1e9050ee367a64f99db4aff8e2d38a2d.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                        </div>--><!--                                        <img src="/static/yhc_files/1e9050ee367a64f99db4aff8e2d38a2d.png"--><!--                                             draggable="false">--><!--                                        <uni-resize-sensor>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                        </uni-resize-sensor>--><!--                                    </uni-image>--><!--                                </uni-view>--><!--                            </uni-view>--></uni-view><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!--                        <uni-view--><!--                                data-v-1eb36b0c="" data-v-4afd20ca="" class="diy-imageSingle"--><!--                                style="padding-bottom: 5px; background: rgb(255, 255, 255);">--><!--                            <uni-view data-v-1eb36b0c=""--><!--                                      class="item-image" style="padding: 5px 0px 0px;">--><!--                                <uni-view data-v-1eb36b0c=""--><!--                                          class="nav-to">--><!--                                    <uni-image data-v-1eb36b0c="" class="image" style="height: 124px;">--><!--                                        <div--><!--                                                style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/0607338b08e9845b6db6b90d83da0f58.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                        </div>--><!--                                        <img src="/static/yhc_files/0607338b08e9845b6db6b90d83da0f58.png"--><!--                                             draggable="false">--><!--                                        <uni-resize-sensor>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                        </uni-resize-sensor>--><!--                                    </uni-image>--><!--                                </uni-view>--><!--                            </uni-view>--><!--                        </uni-view>&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;--><!--                        <uni-view--><!--                                data-v-1eb36b0c="" data-v-4afd20ca="" class="diy-imageSingle"--><!--                                style="padding-bottom: 0px; background: rgb(255, 255, 255);">--><!--                            <uni-view data-v-1eb36b0c=""--><!--                                      class="item-image" style="padding: 0px;">--><!--                                <uni-view data-v-1eb36b0c="" class="nav-to">--><!--                                    <uni-image--><!--                                            data-v-1eb36b0c="" class="image" style="height: 146px;">--><!--                                        <div--><!--                                                style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/d16e7e7bd8735e4bf04cc5a463c65016.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                        </div>--><!--                                        <img src="/static/yhc_files/d16e7e7bd8735e4bf04cc5a463c65016.png"--><!--                                             draggable="false">--><!--                                        <uni-resize-sensor>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                        </uni-resize-sensor>--><!--                                    </uni-image>--><!--                                </uni-view>--><!--                            </uni-view>--><!--                        </uni-view>&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;--><!--                        <uni-view--><!--                                data-v-c3261462="" data-v-4afd20ca="" class="diy-window"--><!--                                style="background: rgb(255, 255, 255); padding: 0px;">--><!--                            <uni-view data-v-c3261462=""--><!--                                      class="data-list avg-sm-2">--><!--                                <uni-view data-v-c3261462="" class="data-item"--><!--                                          style="padding: 0px;">--><!--                                    <uni-view data-v-c3261462="" class="item-image">--><!--                                        <uni-image data-v-c3261462=""--><!--                                                   class="image" style="height: 108px;">--><!--                                            <div--><!--                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/6e25a66132754fe4cad0ae88b7a8544c.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                            </div>--><!--                                            <img src="/static/yhc_files/6e25a66132754fe4cad0ae88b7a8544c.png"--><!--                                                 draggable="false">--><!--                                            <uni-resize-sensor>--><!--                                                <div>--><!--                                                    <div></div>--><!--                                                </div>--><!--                                                <div>--><!--                                                    <div></div>--><!--                                                </div>--><!--                                            </uni-resize-sensor>--><!--                                        </uni-image>--><!--                                    </uni-view>--><!--                                </uni-view>--><!--                                <uni-view data-v-c3261462="" class="data-item"--><!--                                          style="padding: 0px;">--><!--                                    <uni-view data-v-c3261462="" class="item-image">--><!--                                        <uni-image data-v-c3261462=""--><!--                                                   class="image" style="height: 108px;">--><!--                                            <div--><!--                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/e4d48985f825c73f82ad9690424e1db1.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                            </div>--><!--                                            <img src="/static/yhc_files/e4d48985f825c73f82ad9690424e1db1.png"--><!--                                                 draggable="false">--><!--                                            <uni-resize-sensor>--><!--                                                <div>--><!--                                                    <div></div>--><!--                                                </div>--><!--                                                <div>--><!--                                                    <div></div>--><!--                                                </div>--><!--                                            </uni-resize-sensor>--><!--                                        </uni-image>--><!--                                    </uni-view>--><!--                                </uni-view>--><!--                            </uni-view>--><!--                        </uni-view>&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;--><!--                        <uni-view--><!--                                data-v-1eb36b0c="" data-v-4afd20ca="" class="diy-imageSingle"--><!--                                style="padding-bottom: 3px; background: rgb(255, 255, 255);">--><!--                            <uni-view data-v-1eb36b0c=""--><!--                                      class="item-image" style="padding: 3px 0px 0px;">--><!--                                <uni-view data-v-1eb36b0c=""--><!--                                          class="nav-to">--><!--                                    <uni-image data-v-1eb36b0c="" class="image" style="height: 44px;">--><!--                                        <div--><!--                                                style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/aefe0a60bb4c59c88a1d463bbe6b5198.png&quot;); background-size: 100% 100%; background-repeat: no-repeat;">--><!--                                        </div>--><!--                                        <img src="/static/yhc_files/aefe0a60bb4c59c88a1d463bbe6b5198.png"--><!--                                             draggable="false">--><!--                                        <uni-resize-sensor>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                            <div>--><!--                                                <div></div>--><!--                                            </div>--><!--                                        </uni-resize-sensor>--><!--                                    </uni-image>--><!--                                </uni-view>--><!--                            </uni-view>--><!--                        </uni-view>&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;&lt;!&ndash;&ndash;&gt;--><!----><!----><!----><!----><uni-view
                                data-v-22fcf626="" data-v-4afd20ca="" class="diy-goods"
                                style="background: rgb(246, 246, 246);"><uni-view data-v-22fcf626=""
                                      class="goods-list display__list column__2"><uni-scroll-view data-v-22fcf626=""><div class="uni-scroll-view"><div class="uni-scroll-view" style="overflow: hidden;"><div class="uni-scroll-view-content"><!----><uni-view data-v-22fcf626=""
                                                          class="goods-item"><uni-view data-v-22fcf626="" class="goods-image"><uni-image
                                                                data-v-22fcf626="" class="image"><div
                                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/b72822760ccc4bb892cc658b33af939e.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div><img src="/static/yhc_files/b72822760ccc4bb892cc658b33af939e.jpg"
                                                                 draggable="false"><!----></uni-image></uni-view><uni-view data-v-22fcf626="" class="detail"><uni-view
                                                                data-v-22fcf626="" class="goods-name"><uni-text data-v-22fcf626=""
                                                                      class="twoline-hide"><span>文具GP1008/0.5mm黑色中性笔 按动子弹头签字笔 办公用水笔 12支/盒</span></uni-text></uni-view><uni-view data-v-22fcf626=""
                                                                  class="detail-price oneline-hide"><uni-text data-v-22fcf626=""
                                                                      class="goods-price f-30 col-m"><span>0.50/支</span></uni-text><uni-text
                                                                    data-v-22fcf626=""
                                                                    class="line-price col-9 f-24"><span>0.50/支</span></uni-text></uni-view></uni-view></uni-view><uni-view
                                                        data-v-22fcf626="" class="goods-item"><uni-view data-v-22fcf626=""
                                                              class="goods-image"><uni-image data-v-22fcf626="" class="image"><div
                                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/2a6e0c0ea7d1e5f0f2ac3e406198850c.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div><img src="/static/yhc_files/2a6e0c0ea7d1e5f0f2ac3e406198850c.jpg"
                                                                 draggable="false"><!----></uni-image></uni-view><uni-view data-v-22fcf626="" class="detail"><uni-view
                                                                data-v-22fcf626="" class="goods-name"><uni-text data-v-22fcf626=""
                                                                      class="twoline-hide"><span> 串珠,一份5000串,工资4000元</span></uni-text></uni-view><uni-view data-v-22fcf626=""
                                                                  class="detail-price oneline-hide"><uni-text data-v-22fcf626=""
                                                                      class="goods-price f-30 col-m"><span>￥0.80/串</span></uni-text><!----></uni-view></uni-view></uni-view><uni-view
                                                        data-v-22fcf626="" class="goods-item"><uni-view data-v-22fcf626=""
                                                              class="goods-image"><uni-image data-v-22fcf626="" class="image"><div
                                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/41cdb778199f99ebebb6090680f382fc.png&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div><img src="/static/yhc_files/41cdb778199f99ebebb6090680f382fc.png"
                                                                 draggable="false"><!----></uni-image></uni-view><uni-view data-v-22fcf626="" class="detail"><uni-view
                                                                data-v-22fcf626="" class="goods-name"><uni-text data-v-22fcf626=""
                                                                      class="twoline-hide"><span>头绳|发夹一份10000个,工资3600元</span></uni-text></uni-view><uni-view
                                                                data-v-22fcf626="" class="detail-price oneline-hide"><uni-text data-v-22fcf626=""
                                                                      class="goods-price f-30 col-m"><span>￥0.36/个</span></uni-text><!----></uni-view></uni-view></uni-view><uni-view
                                                        data-v-22fcf626="" class="goods-item"><uni-view data-v-22fcf626=""
                                                              class="goods-image"><uni-image data-v-22fcf626="" class="image"><div
                                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/b51b4840c24250a67210d59e345e206d.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div><img src="/static/yhc_files/b51b4840c24250a67210d59e345e206d.jpg"
                                                                 draggable="false"><!----></uni-image></uni-view><uni-view data-v-22fcf626="" class="detail"><uni-view
                                                                data-v-22fcf626="" class="goods-name"><uni-text data-v-22fcf626=""
                                                                      class="twoline-hide"><span>十字绣,大小计算1800到3900</span></uni-text></uni-view><uni-view data-v-22fcf626=""
                                                                  class="detail-price oneline-hide"><uni-text data-v-22fcf626=""
                                                                      class="goods-price f-30 col-m"><span>￥---</span></uni-text><!----></uni-view></uni-view></uni-view><uni-view
                                                        data-v-22fcf626="" class="goods-item"><uni-view data-v-22fcf626=""
                                                              class="goods-image"><uni-image data-v-22fcf626="" class="image"><div
                                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/20190610131953961df5569.PNG&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div><img src="/static/yhc_files/20190610131953961df5569.PNG" draggable="false"><!----></uni-image></uni-view><uni-view data-v-22fcf626="" class="detail"><uni-view
                                                                data-v-22fcf626="" class="goods-name"><uni-text data-v-22fcf626=""
                                                                      class="twoline-hide"><span>平安扣|包装袋,一份10000个,工资3600元</span></uni-text></uni-view><uni-view
                                                                data-v-22fcf626="" class="detail-price oneline-hide"><uni-text data-v-22fcf626=""
                                                                      class="goods-price f-30 col-m"><span>￥0.36/个</span></uni-text><!----></uni-view></uni-view></uni-view><uni-view
                                                        data-v-22fcf626="" class="goods-item"><uni-view data-v-22fcf626=""
                                                              class="goods-image"><uni-image data-v-22fcf626="" class="image"><div
                                                                    style="background-image: url(&quot;https://pffilesa.s3.ap-southeast-1.amazonaws.com/shop/345345sedwe23.png&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div><img src="/static/yhc_files/2018071718294208f086786.jpg" draggable="false"><!----></uni-image></uni-view><uni-view data-v-22fcf626="" class="detail"><uni-view
                                                                data-v-22fcf626="" class="goods-name"><uni-text data-v-22fcf626=""
                                                                      class="twoline-hide"><span>钻石画5幅一份,工资2000元</span></uni-text></uni-view><uni-view data-v-22fcf626=""
                                                                  class="detail-price oneline-hide"><uni-text data-v-22fcf626=""
                                                                      class="goods-price f-30 col-m"><span>￥400.00/幅</span></uni-text><!----></uni-view></uni-view></uni-view><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/20180717182009cb6bf4951.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/20180717182009cb6bf4951.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>三星 Galaxy S9+（SM-G9650/DS）6GB+128GB 谜夜黑 移动联通电信4G 游戏手机--><!--                                    双卡双待</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥6999.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/2018071718130695f254464.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/2018071718130695f254464.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>OPPO R15 直降300◆星云版新品手机 6G+128G R15梦境版 A3同款 R11S升级版 星云版--><!--                                    6+128G 官方标配</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥2699.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/20180717180357119b95367.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/20180717180357119b95367.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>vivo Z1 新一代全面屏 双摄拍照手机 移动联通电信4G 双卡双待 6GB+128GB--><!--                                    瓷釉黑</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥2198.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/20180717175657d4f120465.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/20180717175657d4f120465.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>Apple iPhone X (A1903) 64GB 深空灰色--><!--                                    移动联通4G手机</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥7099.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/20180717174543802b79332.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/20180717174543802b79332.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>Apple iPhone 8 Plus (A1864) 64GB 深空灰色--><!--                                    移动联通电信4G手机</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥5099.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/2018071717370507f183424.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/2018071717370507f183424.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>荣耀9i 4GB+64GB 幻夜黑 移动联通电信4G全面屏手机--><!--                                    双卡双待</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥1399.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/20180717172606d9aee7835.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/20180717172606d9aee7835.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>华为 HUAWEI nova 3全面屏高清四摄游戏手机 6GB+128GB 浅艾蓝限量款 全网通移动联通电信4G手机--><!--                                    双卡双待</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥2788.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/2018071716542894aea9466.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/2018071716542894aea9466.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>小米6X 全网通 4GB+32GB 流沙金 移动联通电信4G手机 双卡双待--><!--                                    智能手机</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥1399.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--><!--                                                <uni-view--><!--                                                        data-v-22fcf626="" class="goods-item">--><!--                                                    <uni-view data-v-22fcf626=""--><!--                                                              class="goods-image">--><!--                                                        <uni-image data-v-22fcf626="" class="image">--><!--                                                            <div--><!--                                                                    style="background-image: url(&quot;http://static.yoshop.xany6.com/2018071716364761fab9153.jpg&quot;); background-position: center center; background-size: cover; background-repeat: no-repeat;">--><!--                                                            </div>--><!--                                                            <img src="/static/yhc_files/2018071716364761fab9153.jpg" draggable="false">--><!--                                                            &lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-image>--><!--                                                    </uni-view>--><!--                                                    <uni-view data-v-22fcf626="" class="detail">--><!--                                                        <uni-view--><!--                                                                data-v-22fcf626="" class="goods-name">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="twoline-hide"><span>小米（MI） 红米6 流沙金 全网通(3G RAM+32G--><!--                                    ROM)</span></uni-text>--><!--                                                        </uni-view>--><!--                                                        <uni-view data-v-22fcf626=""--><!--                                                                  class="detail-price oneline-hide">--><!--                                                            <uni-text data-v-22fcf626=""--><!--                                                                      class="goods-price f-30 col-m"><span>￥739.00</span></uni-text>&lt;!&ndash;&ndash;&gt;--><!--                                                        </uni-view>--><!--                                                    </uni-view>--><!--                                                </uni-view>--></div></div></div></uni-scroll-view></uni-view></uni-view><!----><!----><!----><!----></uni-view></uni-view></uni-page-body></uni-page-wrapper></uni-page><uni-tabbar
            class="uni-tabbar-bottom"><div class="uni-placeholder" style="height: 50px;"></div></uni-tabbar><!----><uni-actionsheet><div class="uni-mask uni-actionsheet__mask" style="display: none;"></div><div class="uni-actionsheet"><div class="uni-actionsheet__menu"><!----><!----><div style="max-height: 260px; overflow: hidden;"><div style="transform: translateY(0px) translateZ(0px);"></div></div></div><div class="uni-actionsheet__action"><div class="uni-actionsheet__cell" style="color: rgb(0, 0, 0);"> 取消</div></div><div></div></div><!----></uni-actionsheet><uni-modal style="display: none;"><div class="uni-mask"></div><div class="uni-modal"><!----><div class="uni-modal__bd"></div><div class="uni-modal__ft"><div class="uni-modal__btn uni-modal__btn_default" style="color: rgb(0, 0, 0);"> Cancel</div><div class="uni-modal__btn uni-modal__btn_primary" style="color: rgb(0, 122, 255);"> OK</div></div></div><!----></uni-modal><!----></uni-app><script src="/static/yhc_files/chunk-vendors.1cf73706.js"></script><script src="/static/yhc_files/index.b12981af.js"></script><div
        style="position: absolute; left: 0px; top: 0px; width: 0px; height: 0px; z-index: -1; overflow: hidden; visibility: hidden;"><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-top);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 400px; height: 400px;"></div></div><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-top);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 250%; height: 250%;"></div></div><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-left);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 400px; height: 400px;"></div></div><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-left);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 250%; height: 250%;"></div></div><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-right);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 400px; height: 400px;"></div></div><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-right);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 250%; height: 250%;"></div></div><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-bottom);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 400px; height: 400px;"></div></div><div
            style="position: absolute; width: 100px; height: 200px; box-sizing: border-box; overflow: hidden; padding-bottom: env(safe-area-inset-bottom);"><div
                style="transition: all 0s ease 0s; animation: 0s ease 0s 1 normal none running none; width: 250%; height: 250%;"></div></div></div></body></html>