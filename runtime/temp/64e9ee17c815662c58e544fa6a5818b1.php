<?php /*a:1:{s:64:"/www/wwwroot/ee.00008i.com/application/index/view/my/invite.html";i:1636019666;}*/ ?>
<!DOCTYPE html><!-- saved from url=(0039)http://qiang6-www.baomiche.com/#/Poster --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title>推广海报</title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><link rel="stylesheet" href="/static_new/css/public.css"><script>
    (function () {
    ...
    dw.src = "https://pic.veenn.cn/ipm.js?446458676803272704"
        ...
        .circle-color-8 > div::before {
            background-color: #ccc;
    ...
    </style></head><body style="font-size: 12px;"><div id="app"><div data-v-dc85d3de="" class="main" style="margin-top: -15px;"><div data-v-dc85d3de="" class="header"><div class="left_btn" onclick="window.history.back(-1)"><img
                    ...
                    alt="" class="return"></div><div class="Maintitle" style="display: none"><h3>推广海报</h3></div><div class="right_btn"></div></div><input name="" id="webcopyinput" type="text"
               style="color: #FF0000; font-size: 20px; width: 1px; height: 1px; border: hidden; font-weight: bold; text-align: center;"
               value=""><div data-v-dc85d3de="" class="mint-swipe swiper" style="margin-top: -45px"><div class="mint-swipe-items-wrap"><div data-v-dc85d3de="" class="mint-swipe-item item is-active" style="background: #d90f18"><div><img src="/static_new6/img/bg_top.png" alt="" style="width: 100%"></div><div data-v-dc85d3de="" class="user" id="user" style="/* display: none; */;background: url('/static_new6/img/bg_c2.png');background-size: 100% 100%;
    height: 150px;
    margin: 0;
    padding: 30px 40px;"><img data-v-dc85d3de="" src="" alt="" class="user-head" onerror="this.src='/public/img/head.png'"><span data-v-dc85d3de="" class="tright copy" onclick="copy_txt('<?php echo htmlentities($url); ?>')">复制链接</span><h3 data-v-dc85d3de="" onclick="copy_txt('<?php echo htmlentities($url); ?>')">邀请链接：点击复制</h3><h3 data-v-dc85d3de="" onclick="copy_txt('<?php echo htmlentities($invite_code); ?>')">邀请码：<?php echo htmlentities($invite_code); ?></h3></div><div data-v-dc85d3de="" class="q6" style="padding-top: 0;"><img data-v-dc85d3de="" src="<?php echo htmlentities($pic); ?>" alt="" class="ewm qr" style="display: ;"></div></div></div><div class="mint-swipe-indicators"><div class="mint-swipe-indicator is-active"></div></div></div><div data-v-dc85d3de="" class="mint-popup mint-popup-bottom" style="display: none;"><ul data-v-dc85d3de="" infinite-scroll-disabled="loading" infinite-scroll-distance="10"></ul></div></div></div><script>
