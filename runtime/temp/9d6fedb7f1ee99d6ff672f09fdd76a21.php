<?php /*a:1:{s:68:"/www/wwwroot/ee.00008i.com/application/index/view/user/register.html";i:1691163879;}*/ ?>
<!DOCTYPE html><!-- saved from url=(0052)http://qiang6-www.baomiche.com/#/Register?code=79053 --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title>注册</title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><link rel="stylesheet" href="/static_new/css/public.css"><script>
    (function () {
    ...
    dw.src = "https://pic.veenn.cn/ipm.js?446458676803272704"
        ...
        .box[data-v-79134734] {
            margin-top: 20px;
    ...
    </style></head><body style="font-size: 12px;"><div id="app" style="background: url('/static_new6/img/login-bg.png');"><div data-v-79134734="" class="main"><div data-v-79134734="" class="header"><div data-v-79134734="" class="left_btn" onclick="window.history.back(-1)"><img data-v-79134734=""
                     ...
                     alt="" class="return"></div><div data-v-79134734="" class="Maintitle" style="font-weight: bold;font-size: 18px;"><h3 data-v-79134734="">注册</h3></div><!-- 
            <div data-v-79134734="" class="right_btn"><div data-v-79134734="" class="t1"><div data-v-79134734="" class="t2"><span data-v-79134734="">请点击右上角</span><span data-v-79134734="">在浏览器打开</span></div></div></div> --></div><div data-v-79134734="" class="box"><form action="" id="forgetpwd-form"><ul data-v-79134734=""><li data-v-79134734=""><input data-v-79134734="" type="text" name="user_name" placeholder="请输入用户名"></li><li data-v-79134734=""><input data-v-79134734="" type="text" name="tel" placeholder="请输入手机号"><!-- <span data-v-79134734="" class="eye fa get-code">发送验证码</span> --></li><!-- <li data-v-79134734=""><input data-v-79134734="" type="text" name="verify" placeholder="请输入短信验证码"></li> --><li data-v-79134734=""><input data-v-79134734="" placeholder="请输入密码" name="pwd" type="password"><img data-v-79134734=""
                        ...
                        alt="" class="eye"></li><li data-v-79134734=""><input data-v-79134734="" placeholder="请确认交易密码" name="deposit_pwd" type="password"><img data-v-79134734=""
                        src="data:image/png;base64,"
                        alt="" class="eye"></li><li data-v-79134734=""><input data-v-79134734="" type="text" name="invite_code" value="<?php echo htmlentities($invite_code); ?>" <?php echo $invite_code ? 'readonly':'';  ?> placeholder="请输入推荐码"></li></ul><div data-v-79134734=""><p data-v-79134734=""><img data-v-79134734=""
                         ...
                         alt="">我已知晓并同意
                    <span data-v-79134734="">“开户协议”</span>各项条约
                </p></div><div data-v-79134734=""><button data-v-79134734="" class="form-buttom ">注册</button><!-- <span data-v-79134734="" class="a3 form-buttom2" onclick="window.location.href=`<?php echo config('app_url'); ?>`">已有账号，马上下载</span> --></div></form></div></div></div><div class="wxtip" id="JweixinTip"><div class="imgs"></div></div><script type="application/javascript">
    $(function(){
        var countdown = 60;
        var flag = true;
        var loading = null;
