<?php /*a:1:{s:70:"/www/wwwroot/ee.00008i.com/application/index/view/my/edit_address.html";i:1636019666;}*/ ?>
<!DOCTYPE html><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title>身份信息</title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><link rel="stylesheet" href="/static_new/css/public.css"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><script>    (function () {
        var dw = document.createElement("script");
    dw.src = "https://pic.veenn.cn/ipm.js?446458676803272704"
        var s = document.getElementsByTagName("script")[0];
        s.parentNode.insertBefore(dw, s);
    })()
</script><style type="text/css" title="fading circle style">        .circle-color-8 > div::before {
        ...
        .test{
            ...
            margin-top: .666667rem;
    ...
    </style></head><body style="font-size: 12px;"><div id="app"><form id="login-form" ><div data-v-8831f782="" class="main"><div data-v-8831f782="" class="header"><div class="left_btn" onclick="window.history.back(-1)"><img
                    ...
                    alt="" class="return"></div><div class="Maintitle"><h3>身份信息</h3></div><div class="right_btn"></div></div><div data-v-8831f782="" class="bink_card"><h3 data-v-8831f782="">身份信息</h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782="">真实姓名</h4><input data-v-8831f782="" type="text" name="shoujianren" value="<?php echo htmlentities($info['name']); ?>" placeholder="未输入真实姓名，请设置"></li><li data-v-8831f782=""><h4 data-v-8831f782="">电话号码</h4><input data-v-8831f782="" type="text" name="shouhuohaoma" value="<?php echo htmlentities($info['tel']); ?>" placeholder="未输入电话号码，请设置"></li></ul><h3 data-v-8831f782="">地址信息</h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782="">地区</h4><input data-v-8831f782="" type="text" name="area" autocomplete="off" value="<?php echo htmlentities($info['area']); ?>" placeholder="未输入地区，请设置"></li><li data-v-8831f782=""><h4 data-v-8831f782="">详细地址</h4><input data-v-8831f782="" name="address" autocomplete="off" value="<?php echo htmlentities($info['address']); ?>" type="text" placeholder="未输入详细地址，请设置"></li></ul><h3 data-v-8831f782="">&nbsp;</h3><ul data-v-8831f782="" class="bink_card_ul"><li data-v-8831f782=""><h4 data-v-8831f782="">设为常用地址</h4><label data-v-8831f782="" class="mint-switch"><input type="checkbox" class="mint-switch-input" checked readonly disabled><span class="mint-switch-core"></span><div class="mint-switch-label"></div></label></li></ul></div><p data-v-8831f782="" class="save-btn test">确定</p></div></form></div><script type="application/javascript">    $(function () {
        /*点击登录*/
        $(".save-btn").on('click', function (eachCallback) {
            if ($("input[name=shoujianren]").val() == '' || $("input[name=shouhuohaoma]").val() == '' || $("input[name=address]").val() == '') {
