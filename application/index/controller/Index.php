...
class Index extends Base
{
    ...
    public function home()
    {
        ...
        $yes3 = strtotime( date("Y-m-d 00:00:00"));
        $yes4 = strtotime( date("Y-m-d 23:59:59"));
       ...
       $this->tod_user_yongjin = db('xy_convey')->where('uid',$uid)->where('status',1)
            ->where('addtime','between',[$yes3,$yes4])->sum('commission');
