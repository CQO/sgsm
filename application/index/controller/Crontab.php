...
{
    //冻结订单
    protected function freeze_order()
    {
     ...
     * @return void
     */
    protected function deal_reward($uid,$oid,$num,$cnum)
    {
...
//        ]);
   ...
   //----------------------------利息宝---------------------------------
    //1 转入 2转出  3每日收益
    protected function lixibao_chu()
    {
        //处理从余额里转出的到账时间
    ...
    protected function lxb_jiesuan()
    {
        $now = time();
